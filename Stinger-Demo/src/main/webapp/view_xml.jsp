...
<html>
    <title>OWASP Stinger Project</title>
    <meta charset="UTF-8">
    ...
    <body>
        ...
        <!-- String stinger_file = getServletContext().getRealPath("/WEB-INF" + request.getParameter("stinger.xml")); -->
            ...
            <div class="w3-row w3-padding-64">
                <div class="w3-twothird w3-container">
                    ...
                    <p>
                        <h3>Stinger source code</h3>
                        <pre style="border: 2px solid black;">
                        <c:import var="StingerSource" url="/WEB-INF/stinger.xml" />
                        <c:out value="${StingerSource}" escapeXml="false" />
                        </pre>
                    </p>
                </div>
            </div>
